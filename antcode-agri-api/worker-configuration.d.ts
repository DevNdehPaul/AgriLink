/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b404c60c3506b204cc5481c3c44c9db2)
...
interface __BaseEnv_Env {
	...
	FAPSHI_BASE_URL: string;
	FAPSHI_API_USER: string;
	FAPSHI_API_KEY: string;
	FAPSHI_PAYOUT_API_USER: string;
	FAPSHI_PAYOUT_API_KEY: string;
	CORS_ORIGINS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "PORT" | "DATABASE_URL" | "NEON_AUTH_BASE_URL" | "NEON_AI_GATEWAY_BASE_URL" | "NEON_AI_GATEWAY_TOKEN" | "DIRECT_URL" | "JWT_ACCESS_SECRET" | "JWT_REFRESH_SECRET" | "JWT_ACCESS_EXPIRES_IN" | "JWT_REFRESH_EXPIRES_IN" | "FAPSHI_BASE_URL" | "FAPSHI_API_USER" | "FAPSHI_API_KEY" | "FAPSHI_PAYOUT_API_USER" | "FAPSHI_PAYOUT_API_KEY" | "CORS_ORIGINS" | "REQUEST_BODY_LIMIT">> {}
}
